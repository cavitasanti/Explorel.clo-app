...
<body>
    <div class="container mx-2 px-2 sm:px-8">
        <h2 class="text-2xl font-extrabold text-gray-700 my-2">Edit Product</h2>
        <form action="{{route('updateproduct', $product->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-2">
                <label for="product_name" class="block mb-2 text-sm font-medium text-gray-900">Product Name</label>
                <input type="text" value="{{ $product->product_name }}" id="product_name" name="product_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Name" required>
            </div>
            <div class="mb-2">
                <label for="product_description" class="block mb-2 text-sm font-medium text-gray-900">Product Desc</label>
                <input type="text" value="{{ $product->product_description }}" id="product_description" name="product_description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Desc" required>
            </div>
            <div class="mb-2">
                <label for="product_price" class="block mb-2 text-sm font-medium text-gray-900">Product Price</label>
                <input type="number" value="{{ $product->product_price }}" id="product_price" name="product_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Price" required>
            </div>
            <div class="mb-2">
                <label for="product_color" class="block mb-2 text-sm font-medium text-gray-900">Product Color</label>
                <input type="text" value="{{ $product->product_color }}" id="product_color" name="product_color" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Color" required>
            </div>
            <div class="mb-2">
                <label for="product_quantity" class="block mb-2 text-sm font-medium text-gray-900">Product Quantity</label>
                <input type="number" value="{{ $product->product_quantity }}" id="product_quantity" name="product_quantity" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Quantity" required>
            </div>
            <div class="mb-2">
